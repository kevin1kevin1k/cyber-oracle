...
8. 使用者可在回答尾端點擊 3 個延伸問題按鈕，系統以同主題追問流程再問一次並扣 1 點。
...
- 回答尾端需產生 3 個不同延伸問題選項，供使用者點擊後直接追問。
...
- 購點成功後 10 秒內反映餘額。
- 歷史頁可查到完整問答與交易紀錄。
- 每次回答尾端固定顯示 3 個延伸問題按鈕，且三個選項內容需互異。
