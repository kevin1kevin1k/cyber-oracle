...
- [x] 完成 Messenger persistent menu MVP（常用入口）
  ...
  - [x] 產品決策：保留自由輸入提問優先，不為了強迫手機版顯示漢堡 menu 而關閉 composer
...
- [x] Messenger：將手機版 persistent menu 可見性收斂為非 blocker；主流程以 greeting / Get Started / 直接提問 / 自動餘額訊息承接
